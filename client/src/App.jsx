      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {activeTab === 'sponsored' && (
          <div className="mb-4 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 text-xs text-emerald-800 dark:text-emerald-300 flex items-start gap-2">
            ...
            <span>
              Jobs from companies on the <strong>UK Home Office Skilled Worker register</strong>, or listings
              that explicitly mention <strong>visa sponsorship</strong> — worldwide. Jobs that state
              sponsorship is unavailable are excluded.
            </span>
          </div>
        )}
